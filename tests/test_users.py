...
class TestUsers(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.user = Users(first_name="Test", last_name="last_name_test", email="email@test.com", password=generate_password_hash(('12345'), role="user"))
    ...
    def test_get_users(self):
        ...
        self.assertEqual(response.json[0]['email'], 'email2@test.com')
